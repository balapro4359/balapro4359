...
# Source: https://github.com/indranilbanerjee/digital-marketing-pro (scripts/sample-size-calculator.py)
# Copied verbatim except for this header; see THIRD_PARTY_NOTICES.md.
#!/usr/bin/env python3
"""
